    ...
    <div class="container">
      <div class="login-page clearfix">
        ...
        <div class="login-box auth0-box before">
          <img src="https://raw.githubusercontent.com/FarmRadioHangar/uliza-core-apis/master/logo.png" />
          <h3>Farm Radio Login</h3>
          <a class="btn btn-primary btn-lg btn-login btn-block">SignIn</a>
        </div>
        <?php else: ?>
        <div class="logged-in-box auth0-box logged-in">
          <h1 id="logo"><img src="https://raw.githubusercontent.com/FarmRadioHangar/uliza-core-apis/master/logo.png" /></h1>
