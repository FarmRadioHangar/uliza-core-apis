exports.up = (pg) => {
  ...
  pg.sql("GRANT ALL ON farmradio_api.participant_registration_status_log TO app;");
  pg.sql("GRANT USAGE, SELECT ON SEQUENCE farmradio_api.participant_registration_status_log_id_seq TO app;");
};
