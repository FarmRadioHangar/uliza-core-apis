BEGIN;
  ...
  GRANT ALL ON farmradio_api.participant_registration_status_log TO admin;
  GRANT USAGE, SELECT ON SEQUENCE farmradio_api.participant_registration_status_log_id_seq TO admin;
